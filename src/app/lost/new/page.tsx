...
export default async function NewLostPage({ searchParams }: { searchParams: Promise<{ petId?: string }> }) {
  ...
  return (
    <MobileShell>
      <div className="form-page">
        ...
        <LostForm linkedPet={pet ? { publicId: pet.public_id, name: pet.name } : undefined} />
      </div>
    </MobileShell>
  );
}
